      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <?php foreach($l_cat as $cat_item) { ?>
              <li><a class="dropdown-item" href="filtre.php?cat_no=<?= $cat_item['id_categorie'] ?>">
                <?= htmlspecialchars($cat_item['nom_categorie']) ?>
              </a></li>
            <?php } ?>
...
<div class="container mt-5">
  <h1 class="text-left mb-4">
    Objets de la catégorie « <?= htmlspecialchars(get_nom_categorie($_GET['cat_no'])) ?> »
  :</h1>
